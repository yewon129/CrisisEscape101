def ts(sentence):
    ...
    print('코사인 유사도: ', cs[0][0]) # -1 ~ 1 : 1에 가까울 수록 유사함
    ...
    print('유클리디언 유사도: ', ed[0][0]) # 값이 작을수록 유사함
    ...
    print('정규화 + 유클리디언 유사도: ', ned[0][0]) # 값이 작을수록 유사함
    ...
    print('정규화 + 맨하탄 유사도: ', md[0][0]) # 0 ~ 1 : 값이 작을수록 유사함
